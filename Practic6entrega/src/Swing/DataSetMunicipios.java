...
/**	public final List<Municipio> getlMunicipios() {
		return lMunicipios;
	}
**/
...
//TAREA 4
	public List<Municipio> MunicipiosPorProvincia(String provinciaSelec){
		List<Municipio> listaMunis = new ArrayList<>();
		for(Municipio muni: lMunicipios) {
...
//TAREA 11
	public int HabitantesPorProvincia(String provinciaSelec){
		int habitantes = 0;
		for(Municipio m: MunicipiosPorProvincia(provinciaSelec)) {
			habitantes += m.getHabitantes();
		}
		return habitantes;
	}
